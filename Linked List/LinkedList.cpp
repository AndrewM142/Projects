...
void LinkedList::insert(int element) //Inserts node into linked list
{
...
void LinkedList::printList() //prints linked list
{
	if(!isEmpty()) //If list is not empty
	{
		...
		std::cout << currentLinkedNode->getValue(); //prints value of head node
...
void LinkedList::insertLinkedNode(LinkedNode * node, int element) //Helps insert objects with referenced node
{
